        ...
        <div class="pt-8">
            ...
            <div class="flex items-center justify-center lg:justify-start space-x-4 mb-6">
                ...
                <a 
                    ...
                    class="w-10 h-10 bg-[#1877F2] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                ...
                <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    class="w-10 h-10 bg-[#1DA1F2] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    class="w-10 h-10 bg-[#FF0000] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Trademark & Legal Links Container -->
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 text-center lg:text-left">
                
                <!-- Left: Trademark -->
                <div class="text-[#454452] text-xs sm:text-sm border-t border-[#454452]">
                    <p class="mb-2">Fasticore Platform are trademarks from Fasticore Technology</p>
                    <p>© Copyright by Fasticore Technology – All right reserved</p>
                </div>
