<section class="py-16 sm:py-20 lg:py-24 mt-10 bg-gradient-to-b bg-[#454452]">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-16 text-center">
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#ffffff]">
                Our Clients Journey
            </h2>
        </div>
        ...
        <div class="relative max-w-5xl mx-auto">
            ...
            <div class="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-0.5 bg-[#4B5563]"></div>
            ...
            <div class="space-y-0">
                ...
                >
                    <div class="grid grid-cols-2 gap-8 items-center">
                        <div class="text-right pr-12">
                            <div class="bg-[#454452] shadow-lg rounded-lg p-6 inline-block">
                                <div class="flex items-start justify-end mr-3">
                                    <img src="{{ asset('images/icons/consulting.png') }}" alt="Consulting" class="w-16 h-16 ml-4">
                        ...
                        <div class="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-primary rounded-full border-4 border-gray-700 z-10"></div>
                    </div>
                </div>
                ...
                >
                    <div class="grid grid-cols-2 gap-8 items-center">
                        ...
                        <div class="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-primary rounded-full border-4 border-gray-700 z-10"></div>
                        <div class="pl-12">
                            <div class="bg-[#454452] shadow-lg rounded-lg p-6">
                                <div class="flex items-start">
                                    <img src="{{ asset('images/icons/project.png') }}" alt="Project Discussion" class="w-16 h-16 mr-4">
                                    <div>
                        ...
                        <div class="text-right pr-12">
                            <div class="bg-[#454452] shadow-lg rounded-lg p-6 inline-block">
                                <div class="flex items-start justify-end">
                                    <img src="{{ asset('images/icons/planning.png') }}" alt="Project Planning" class="w-16 h-16 ml-4">
                                    <div class="text-left ml-3">
                ...
                >
                    <div class="grid grid-cols-2 gap-8 items-center">
                        ...
                        <div class="pl-12">
                            <div class="bg-[#454452] shadow-lg rounded-lg p-6">
                                <div class="flex items-start">
                                    <img src="{{ asset('images/icons/development.png') }}" alt="Project Development" class="w-16 h-16 mr-4">
                                    <div>
                ...
                >
                    <div class="grid grid-cols-2 gap-8 items-center">
                        <div class="text-right pr-12">
                            <div class="bg-[#454452] shadow-lg rounded-lg p-6 inline-block">
                                <div class="flex items-start justify-end">
                                    <img src="{{ asset('images/icons/testing.png') }}" alt="Project Testing" class="w-16 h-16 ml-4">
                                    <div class="text-left ml-3">
                ...
                >
                    <div class="grid grid-cols-2 gap-8 items-center">
                        ...
                        <div class="pl-12">
                            <div class="bg-[#454452] shadow-lg rounded-lg p-6">
                                <div class="flex items-start">
                                    <img src="{{ asset('images/icons/deployment.png') }}" alt="Deployment and Handover" class="w-16 h-16 mr-4">
                                    <div>
