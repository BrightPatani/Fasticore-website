  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
    ...
    <div class="flex flex-col justify-center sm:flex-row items-center sm:items-start gap-8 sm:gap-12 lg:gap-16">
      ...
      <div class="text-center sm:text-left max-w-2xl">
        <h2 class="text-xl sm:text-2xl font-bold text-[#FF6701] mb-3">
          About us
        </h2>
        <p class="text-[#454452] text-xl sm:text-base leading-relaxed">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mx-auto max-w-7xl">
        ...
        <div 
            ...
            class="bg-[#ffffff] rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden"
            :class="hover ? 'transform -translate-y-2' : ''"
        >
            <div class="p-6">
                <!-- Card Header -->
                <h3 class="text-xl sm:text-2xl font-bold text-[#FF6701] mb-4">
                    Vision
                </h3>
